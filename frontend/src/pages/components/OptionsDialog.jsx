...
const OptionsDialog = forwardRef(OptionsDialogFunc);

function OptionsDialogFunc ({ enabled, options, title, callback, config, className }, ref) {
  ...
  return (
    <>
      <div className={'options-dialog' + (className === undefined ? '' : ` ${className}`)} ref={ref}>
        <div
...
export { OptionsDialog as default };
